...
# =========================
hp_cycle <- function(x, lambda = 100, min_t = 30){
...
# =========================
# 7) 1st-order autocorr (persistence) by country/region
# =========================
acf_by_country <- WDI_hpcycle %>%
  arrange(`Country Code`, Year) %>%
  group_by(`Country Code`, Region) %>%
  summarise(
...
# 8) Export
# =========================
write_csv(sd_by_country, "sd_by_country_hp.csv")
write_csv(sd_by_region,  "sd_by_region_hp.csv")
write_csv(sd_ratio_by_region, "sd_ratio_by_region_hp.csv")

write_csv(corr_by_country, "corr_by_country_hp.csv")
write_csv(corr_by_region,  "corr_by_region_hp.csv")

write_csv(acf_by_country, "acf_by_country_hp.csv")
write_csv(acf_by_region,  "acf_by_region_hp.csv")
